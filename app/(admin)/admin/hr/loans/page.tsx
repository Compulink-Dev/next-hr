...
import LoanPage from './_components/LoanCard'
...
async function Loans() {
    ...
    const columns = ['payment', 'type', 'amount', 'repayment', 'repayments', 'reason', 'status', 'interest', 'installment', 'attachment', 'createdAt']

    return (
        <div>
            <FixedHeader
                link={'admin/hr/loans/new'}
                title='Loan'
            />
