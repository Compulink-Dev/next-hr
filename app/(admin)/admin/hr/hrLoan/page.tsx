...
const loans = [
    { id: 1, applicant: 'John Doe', amount: 5000, status: 'Pending', reason: '', date: '2024-10-01' },
    { id: 2, applicant: 'Jane Smith', amount: 3000, status: 'Pending', reason: '', date: '2024-10-02' },
    { id: 3, applicant: 'Mike Ross', amount: 7000, status: 'Pending', reason: '', date: '2024-09-28' },
];
                            ...
                            <tr key={loan.id}>
                                ...
                                <td className="px-4 py-2 border">
                                    <input
                                        type="text"
                                        value={loan.reason}
                                        onChange={(e) => handleReasonChange(loan.id, e.target.value)}
