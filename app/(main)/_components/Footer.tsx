            ...
            <div className="mx-auto max-w-screen-xl">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <a href="https://compulinl.co.zw" className="flex items-center">
                            <img src="/compulink.png" className="mr-3 h-8" alt="Compulink" />
                            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Compulink</span>
                        </a>
                    </div>
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <ul className="text-gray-600 dark:text-gray-400">
                                <li className="mb-4">
                                    <a href="https://compulink.co.zw" className="hover:underline">Compulink</a>
                                </li>
                                <li>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://compulink.co.zw" className="hover:underline">Compulink</a>. All Rights Reserved.
                    </span>
