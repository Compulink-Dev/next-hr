        ...
        <div className="">
            {
                loading ?
                    ...
                    (
                        <button disabled type="button" className="py-2.5 px-5 me-2 text-sm font-medium text-red-900 bg-white rounded-lg border border-stone-200 hover:bg-stone-100 hover:text-red-700 focus:z-10 focus:ring-4 focus:outline-none focus:ring-red-700 focus:text-red-700 dark:bg-red-800 dark:text-red-400 dark:border-red-600 dark:hover:text-white dark:hover:bg-red-700 inline-flex items-center">
                            <svg aria-hidden="true" role="status" className="inline w-4 h-4 me-3 text-red-200 animate-spin dark:text-stone-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
