...
async function Documents() {
  const documentsData = {
    all: [
      {
        title: "Google Chrome",
        description: "Access and share availability on any web pages",
        downloadLink: "/documents/chrome.pdf",
      },
      {
        title: "Firefox",
        description: "Browse fast and secure with Firefox",
        downloadLink: "/documents/firefox.pdf",
      },
    ],
    technical: [
      {
        title: "Technical Manual",
        description: "Comprehensive guide to technical support",
        downloadLink: "/documents/technical_manual.pdf",
      },
    ],
    sales: [
      {
        title: "Sales Presentation",
        description: "Detailed sales strategies and pitches",
        downloadLink: "/documents/sales_presentation.pdf",
      },
    ],
    networks: [
      {
        title: "Network Setup",
        description: "Step-by-step guide to setting up a network",
        downloadLink: "/documents/network_setup.pdf",
      },
    ],
    software: [
      {
        title: "Software Installation Guide",
        description: "Install software with ease",
        downloadLink: "/documents/software_installation.pdf",
      },
    ],
    accounts: [
      {
        title: "Account Management",
        description: "Manage accounts effectively",
        downloadLink: "/documents/account_management.pdf",
      },
    ],
  };
